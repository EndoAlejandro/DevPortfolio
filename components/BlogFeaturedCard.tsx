...
export default function BlogFeaturedCard({ post }: { post: Post }) {
  return (
    ...
    >
      <div className="flex-1 basis-[440px] min-w-[300px] relative border-r border-line">
        <span className="absolute top-4 left-4 z-[2] font-mono text-[11px] font-medium uppercase tracking-[0.06em] text-paper bg-accent rounded-chip px-[9px] py-1">
          Latest
        </span>
      ...
      <div className="flex-1 basis-[320px] min-w-[280px] p-[34px] flex flex-col justify-center">
        <div className="font-mono text-[12px] font-medium uppercase tracking-[0.04em] text-ink/50 mb-[14px]">
